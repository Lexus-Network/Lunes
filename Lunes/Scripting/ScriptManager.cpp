...
void ScriptManager::prepareLunesFunctions(JsValueRef global, ContextObjects* obj) {
	...
	JsValueRef LunesObject;
	chakra.JsCreateObject_(&LunesObject);

	chakra.addPropertyToObj(global, L"Lunes", LunesObject);

	chakra.defineFunction(LunesObject, L"getCommandManager", LunesFunctions::getCommandManager, obj);
	chakra.defineFunction(LunesObject, L"getModuleManager", LunesFunctions::getModuleManager, obj);
	chakra.defineFunction(LunesObject, L"getDrawUtils", LunesFunctions::getDrawUtils, obj);
}
...
void ScriptManager::prepareContext(JsContextRef* ctx, ContextObjects* obj) {
	...
	prepareLunesFunctions(globalObject, obj);

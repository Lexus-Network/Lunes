...
static constexpr float textPaddingX = 1.0f;
...
//static constexpr float backgroundAlpha = 0.0;

static const MC_Color whiteColor = MC_Color(1.f, 1.f, 1.f, 1.f);
static const MC_Color moduleColor = MC_Color(16, 16, 16);                         // background
static const MC_Color selectedModuleColor = MC_Color(80,80,80);  // 30, 110, 200
...
static const MC_Color selectedSettingColor1 = MC_Color(80,80,80);
static const MC_Color selectedSettingColor2 = MC_Color(80,80,80);
static const MC_Color SettingColor1 = MC_Color(16, 16, 16);
static const MC_Color SettingColor2 = MC_Color(16, 16, 16);
							...
							case ValueType::INT_T: {
								...
								// Slider
								{
									...
									// Visuals & Logic
									{
										...
										{
											rect.z = rect.x + value;
											DrawUtils::fillRectangle(rect, MC_Color(16, 16, 16), (areWeFocused || setting->isDragging) ? 1.f : 0.8f);
										}
...
void ClickGui::render() {
	...
	renderCategory(Category::COMBAT, guimod->rainbowCategories, guimod->transparent ? 0.3f : 1.f);
	renderCategory(Category::VISUAL, guimod->rainbowCategories, guimod->transparent ? 0.3f : 1.f);
	renderCategory(Category::MOVEMENT, guimod->rainbowCategories, guimod->transparent ? 0.3f : 1.f);
	renderCategory(Category::PLAYER, guimod->rainbowCategories, guimod->transparent ? 0.3f : 1.f);
	renderCategory(Category::MISC, guimod->rainbowCategories, guimod->transparent ? 0.3f : 1.f);
	renderCategory(Category::WORLD, guimod->rainbowCategories, guimod->transparent ? 0.3f : 1.f);
	renderCategory(Category::GUI, guimod->rainbowCategories, guimod->transparent ? 0.3f : 1.f);
	//renderCategory(Category::CPVP, guimod->rainbowCategories, guimod->transparent ? 0.3f : 1.f);

	if (scriptMgr.getNumEnabledScripts() > 0)
		renderCategory(Category::CUSTOM, guimod->rainbowCategories, guimod->transparent ? 0.3f : 1.f);

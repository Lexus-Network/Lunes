...
void ModuleManager::initModules() {
	logF("Initializing modules");
	{
		...
		moduleList.push_back(std::shared_ptr<IModule>(new CrystalAura2()));
		moduleList.push_back(std::shared_ptr<IModule>(new CrystalAuraBPG()));
		moduleList.push_back(std::shared_ptr<IModule>(new CrystalMove()));
		moduleList.push_back(std::shared_ptr<IModule>(new CrystalReplenishment()));
		moduleList.push_back(std::shared_ptr<IModule>(new Background()));
